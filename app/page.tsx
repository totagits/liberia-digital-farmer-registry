...
const features = [
  ["01", "One national farmer record", "Register farmers, households, farms, parcels, cooperatives and agribusinesses once—then serve them across authorized programmes."],
  ["02", "Field-ready GIS", "Capture GPS points and parcel boundaries, calculate area, validate geometry and synchronize when connectivity returns."],
  ["03", "Interoperable by design", "Secure open APIs connect agriculture, social protection, identity, statistics, land, weather and payment ecosystems."],
  ["04", "Trusted decisions", "Verification workflows, data-quality controls, audit history and gender-, youth- and geography-disaggregated analytics."],
];
    ...
    <main id="home">
      ...
      <section className="hero">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-actions"><Link className="primary" href="/dashboard">Explore the live platform <span>→</span></Link><a className="secondary" href="#platform"><span className="play">▶</span> See how it works</a></div>
      ...
      <footer id="about"><div><img src="/assets/liberia-seal.png" alt="Republic of Liberia"/><strong>Digital Farmer Registry</strong></div><p>A Government of Liberia platform led by the Ministry of Agriculture with technical support from FAO.</p><Link href="/dashboard">Enter the platform →</Link></footer>
    </main>
  );
}
