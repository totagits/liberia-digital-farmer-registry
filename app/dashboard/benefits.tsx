  ...
  if(modal==="voucher-details" && selected) {
    ...
    return (
      <div className="modal-wrap">
        <section className="register-modal glass compact-modal voucher-detail-card" style={{ maxWidth: "680px", width: "100%" }}>
